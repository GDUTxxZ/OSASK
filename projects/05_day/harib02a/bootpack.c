...
void HariMain(void)
{
	...
	init_palette();
	binfo_scrnx = (short *) 0x0ff4; // 当前画面模式的分辨率x存放的内存地址
	binfo_scrny = (short *) 0x0ff6; // 当前画面模式的分辨率y存放的内存地址
	binfo_vram = (int *) 0x0ff8; // vram的内存地址基址
	xsize = *binfo_scrnx; // 当前分辨率x
	ysize = *binfo_scrny; // 当前分辨率y
